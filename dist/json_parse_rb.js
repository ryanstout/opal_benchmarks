...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, example = nil;

  Opal.add_stubs(['$require', '$length', '$to_json']);
  self.$require("json");
  example = $hash2(["data"], {"data": [$hash2(["name"], {"name": "Ryan"}), $hash2(["name"], {"name": "Bob"}), $hash2(["name"], {"name": "Jimmy"})]});
